...
当一个Vue实例创建时，Vue会遍历data中的属性，用 Object.defineProperty（vue3.0使用proxy ）将它们转为 getter/setter，并且在内部追踪相关依赖，在属性被访问和修改时通知变化。 每个组件实例都有相应的 watcher 程序实例，它会在组件渲染的过程中把属性记录为依赖，之后当依赖项的setter被调用时，会通知watcher重新计算，从而致使它关联的组件得以更新。 ![0_tB3MJCzh_cB6i3mS-1.png](D:\学习\笔记\notes\面试题\vue\images\b1b16025a35b4cd2b343a92e740621b7tplv-k3u1fbpfcp-zoom-in-crop-mark3024000.webp)
...
![img](D:\学习\笔记\notes\面试题\vue\images\a286bdc076ae425fb9591bb8c4153240tplv-k3u1fbpfcp-zoom-in-crop-mark3024000.webp)
...
MVC 通过分离 Model、View 和 Controller 的方式来组织代码结构。其中 View 负责页面的显示逻辑，Model 负责存储页面的业务数据，以及对相应数据的操作。并且 View 和 Model 应用了观察者模式，当 Model 层发生改变的时候它会通知有关 View 层更新页面。Controller 层是 View 层和 Model 层的纽带，它主要负责用户与应用的响应操作，当用户与页面产生交互的时候，Controller 中的事件触发器就开始工作了，通过调用 Model 层，来完成对 Model 的修改，然后 Model 层再去通知 View 层更新。 ![image.png](D:\学习\笔记\notes\面试题\vue\images\a65e1b9145894647a25788caf12ddd26tplv-k3u1fbpfcp-zoom-in-crop-mark3024000.webp)
...
这种模式实现了 Model和View的数据自动同步，因此开发者只需要专注于数据的维护操作即可，而不需要自己操作DOM。 ![image.png](D:\学习\笔记\notes\面试题\vue\images\d5ce15b7b704483eb91ee1f5d1d64786tplv-k3u1fbpfcp-zoom-in-crop-mark3024000.webp)
...
在Vue中，对响应式处理利用的是Object.defineProperty对数据进行拦截，而这个方法并不能监听到数组内部变化，数组长度变化，数组的截取变化等，所以需要对这些操作进行hack，让Vue能监听到其中的变化。 ![image.png](D:\学习\笔记\notes\面试题\vue\images\6be20296a76f4e7085dfb510a3211d16tplv-k3u1fbpfcp-zoom-in-crop-mark3024000.webp) 那Vue是如何实现让这些数组方法实现元素的实时更新的呢，下面是Vue中对这些方法的封装：
...
**区别：** ![775316ebb4c727f7c8771cc2c06e06dd.jpg](D:\学习\笔记\notes\面试题\vue\images\76b3d747986e45e096abaf64faf5e332tplv-k3u1fbpfcp-zoom-in-crop-mark3024000.webp)
...
![bb253b1d177f421741af0e7dd0f52b5e.jpg](D:\学习\笔记\notes\面试题\vue\images\5e7df745017242a7beaba81e854a0f97tplv-k3u1fbpfcp-zoom-in-crop-mark3024000.webp) **（2）mergeOptions 的执行过程**
...
![b025e120ca3d0bd2ded3d038d58cacf4.jpg](D:\学习\笔记\notes\面试题\vue\images\92fc4b2c6e414344b9b22bc057dcd39ctplv-k3u1fbpfcp-zoom-in-crop-mark3024000.webp) Vuex为Vue Components建立起了一个完整的生态圈，包括开发中的API调用一环。 **（1）核心流程中的主要功能：**
