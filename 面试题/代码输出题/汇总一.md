...
实际上，这段代码就是在实现原型链继承，SubType继承了SuperType，本质是重写了SubType的原型对象，代之以一个新类型的实例。SubType的原型被重写了，所以instance.constructor指向的是SuperType。具体如下： ![image.png](D:\学习\笔记\notes\面试题\代码输出题\images\8823cf14d07040379eb890c09255c35dtplv-k3u1fbpfcp-zoom-in-crop-mark3024000.webp)
